...
const ignores = ["node_modules/**/*", ".mesh/**/*", "build/**/*", "specs/**/*", "grpc-handler/*"];
...
export default [
    ...
    {
        files: ["package.json"],
        ignores: ["node_modules/**/*", ".mesh/**/*", "build/**/*", "config/specs/**/**"],
        languageOptions: {
    ...
    {
        ...pluginYml.configs['flat/recommended'][0],
        ...pluginYml.configs['flat/recommended'][1],
        files: ["**/*.yaml", "**/*.yml"],
        ignores,
    },
];